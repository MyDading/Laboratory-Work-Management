...
namespace login
{
    public partial class formLogin : Form
    {
        ...
        public formLogin()
        {
            ...
            //conn = new MySqlConnection("Data Source=localhost;Initial Catalog=test;User ID=root;Password=since2012");       //在方法里面使用

            //string url = "server=127.0.0.1;user=root;database=autotest;port=3306;password=since2012;";      //指明要连接的数据库地址，用户名，数据库名，端口，密码
            //MySqlConnection conn = new MySqlConnection(url);    //实例化连接

            conn = new MySqlConnection("server=127.0.0.1;user=root;database=users;port=3306;password=sas124578;");       //在方法里面使用
        }
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State.ToString() == "Open")
            {
                ...
                string cmdStr1 = "INSERT INTO userinfo (userName, passWord) VALUES('YAOMING', YAOMING),('JORDAN', JORDAN),('DUNKEN', DUNKEN)";
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            string cmdStr = "Select * from userinfo where username='" + userName + "'AND passWord='" + passWord + "'";
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            string cmdStr = "INSERT INTO userinfo VALUES('" + userName + "','" + passWord + "')";
       ...
       {
           MySqlConnection m_conn = new MySqlConnection("server=localhost;user id=root;password=sas124578;persist security info=True;database=login_test");
           m_conn.Open();
           MySqlCommand cmd = new MySqlCommand("CREATE TABLE PERSON(ID INT(4) PRIMARY KEY NOT NULL AUTO_INCREMENT,PERSONCODE VARCHAR(255) DEFAULT NULL,PERSONNAME1 VARCHAR(255) DEFAULT NULL)", m_conn);
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string strcon = "server=localhost;database=users;uid=root;pwd=sas124578;";
                ...
                try
                {
                    ...
                    con.Open();
                    //3. sql语句
                    string sqlSel = "select count(*) from users.login where user_name = '" + userName + "' and user_password = '" + userPassword + "'";
